...
def main(subject_id,study_id_1,study_id_2,dicom_id_1,dicom_id_2):
    image1_path = rf"data\\jpg\\{subject_id}\{study_id_1}\{dicom_id_1}.jpg"
    image2_path = rf"data\\jpg\\{subject_id}\{study_id_2}\{dicom_id_2}.jpg"
    ...
    try:
        ...
        output_dir = r"diff_img"
        comparator.visualize_comparison(
            save_path=os.path.join(output_dir, f"{dicom_id_1}_{dicom_id_2}_comparison_result_cn.png")
        )
        
        print("\n7. Generating difference heatmap...")
        comparator.create_difference_heatmap(
            save_path=os.path.join(output_dir, f"{dicom_id_1}_{dicom_id_2}_difference_heatmap_cn.png")
        )
...
def compare_diff_result():
    ...
    # JSON文件路径
    json_path = r"data\sceneGraph_json\\99eb5ea2-76aff341-b0db7fe2-24d9295f-cd6d9b2e_SceneGraph.json"
    ...
    try:
        ...
        # 重新运行分析获取结果
        image1_path = r"data\\jpg\\p11000566\s50230446\\2e4678a5-e646a648-d6265814-63b082e3-d14f047a.jpg"
        image2_path = r"data\\jpg\\p11000566\s50252971\\99eb5ea2-76aff341-b0db7fe2-24d9295f-cd6d9b2e.jpg"
...
if __name__ == "__main__":
    ...
    subject_id = "p10364180"
    study_id_1 = "s58610981"
    study_id_2 = "s52240068"
    dicom_id_1 = "92a109ae-8678df55-f1cf1f1b-ef4ce4ef-cafc1c8e"
    dicom_id_2 = "c9b73a30-a9fbe615-f08e4cdb-9dc85707-8f45face"
    main(subject_id,study_id_1,study_id_2,dicom_id_1,dicom_id_2)
    # compare_diff_result()
